...
export function SidebarDashboard({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      >
        <header className="md:hidden flex items-center justify-between border-b px-4 xp-6 h-14 z-10 sticky top-0 bg-white">
          <Sheet>
            ...
            <SheetContent side="right" className="sm:max-w-xs px-4 text-black">
